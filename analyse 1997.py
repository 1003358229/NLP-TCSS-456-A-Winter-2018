...
file = open('D:/HOME/TCSS456/NLP-TCSS-456-A-Winter-2018/1997/tmp/dictionary.dic','w')
dictionary.save('D:/HOME/TCSS456/NLP-TCSS-456-A-Winter-2018/1997/tmp/dictionary.dic')
file.close()
##print(dictionary)
print('7----------------------------------------------------------------------------------------------------------------')
...
file = open('D:/HOME/TCSS456/NLP-TCSS-456-A-Winter-2018/1997/tmp/corpus.cop','w')
corpora.MmCorpus.serialize('D:/HOME/TCSS456/NLP-TCSS-456-A-Winter-2018/1997/tmp/corpus.cop', corpus)
file.close()
##print(corpus)
print('9----------------------------------------------------------------------------------------------------------------')
